      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-info">
            <h3 className="footer-name">Muhammed Ahmed Abubakr</h3>
            <p className="footer-title">Backend / Full Stack .NET Developer</p>
          </div>
        ...
        <div className="footer-bottom">
          <p className="copyright">© {displayYear} Muhammed Ahmed Abubakr. All rights reserved.</p>
